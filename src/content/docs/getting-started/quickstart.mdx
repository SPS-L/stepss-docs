...
3. **Run Power Flow**: Execute Helios to compute the initial operating point
...
1. **Launch STEPSS**, from your applications if you used an installer, or by double-clicking `stepss.jar`
2. **Load data files**: Use File → Open to load network and power flow data files
3. **Run Power Flow**: Click the Helios button to compute the power flow
