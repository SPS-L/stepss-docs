...
STEPSS itself (`stepss.jar`) is downloaded directly from the [stepss-java-ui repository](https://github.com/SPS-L/stepss-java-ui/raw/main/dist/stepss.jar). The auxiliary installers (Java, Visual Studio) can be downloaded from the [Google Drive folder](https://drive.google.com/drive/folders/1HcUSD-FOx6192HURJnxltYJuKuNA8Vwz?usp=drive_link).
...
1. Download [`stepss.jar`](https://github.com/SPS-L/stepss-java-ui/raw/main/dist/stepss.jar) from the [stepss-java-ui repository](https://github.com/SPS-L/stepss-java-ui)
