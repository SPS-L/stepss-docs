...
STEPSS itself (`stepss.jar`) is downloaded directly from this site. The auxiliary installers (Java, Visual Studio) can be downloaded from the [Google Drive folder](https://drive.google.com/drive/folders/1HcUSD-FOx6192HURJnxltYJuKuNA8Vwz?usp=drive_link).
