...
The additional IEEE variants documented in the catalogue below (e.g. `AC1A_MAXEX2`, `AC1A_RETRO`, `AC8B*`, `DC3A`, `EXPIC1`, `SEXS_STAB3_lim`, `ST1A_lim`, `ST1A_PSS3B`, `ST1A_*_MAXEX2`, `ST1A_*_OELHQ`, `ST2A`, and the Hydro-Québec `EXHQSC*` family) are not callable out of the box. They can be enabled by extending RAMSES through URAMSES (see the [URAMSES guide](/developer/uramses/)).
:::
