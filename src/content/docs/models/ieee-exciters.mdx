...
The EXHQSC family is a proprietary model developed by Hydro-Québec. It is included for compatibility with existing simulation cases. New studies should prefer standard IEEE models such as ST1A.
:::
...
:::note[Proprietary Model]
The OELHQ is a proprietary over-excitation limiter developed by Hydro-Québec. It is included for compatibility with existing simulation cases.
:::
