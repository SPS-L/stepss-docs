...
### `FRT` (`dctl_FRT`): Fault Ride-Through Controller
...
### `PST` (`dctl_pst`): Phase-Shifting Transformer Control
...
### `RT` (`dctl_rt`): Real-Time Simulation Control
