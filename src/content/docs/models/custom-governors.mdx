...
This page documents the four governors built into every RAMSES distribution, `CONSTANT`, `1ST_ORDER`, `HYDRO_GENERIC1` and `THERMAL_GENERIC1`, which take no prefix and are written in uppercase.
