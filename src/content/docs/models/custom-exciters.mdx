...
<TabItem label="RAMSES Data File">
```
exc exc_1storder GEN1
  200.0  ! KA: AVR gain
  0.05   ! TA: time constant (s)
  0.0    ! Vfmin (pu)
  6.0    ! Vfmax (pu)
;
```
...
```
exc exc_kundur GEN1
  0.02   ! TR: voltage filter (s)
  200.0  ! KA: AVR gain
  0.02   ! TA: TGR lead (s)
  10.0   ! TB: TGR lag (s)
  9.5    ! KSTAB: PSS gain
  1.41   ! TW: washout (s)
  0.154  ! T1: PSS lead 1 (s)
  0.033  ! T2: PSS lag 1 (s)
  0.154  ! T3: PSS lead 2 (s)
  0.033  ! T4: PSS lag 2 (s)
;
```
</TabItem>
<TabItem label="Notes">
...
<TabItem label="RAMSES Data File">
```
exc exc_generic1 GEN1
  1.05   ! IFLIM: OEL threshold (pu)
  0.02   ! d: dead zone
  0.5    ! f: OEL characteristic
  0.0    ! S
  1.0    ! K1
  1.0    ! K2
  0.0    ! L1: OEL lower limit
  0.5    ! L2: OEL upper limit
  200.0  ! G: AVR gain
  0.02   ! TA (s)
  0.10   ! TB (s)
  0.05   ! TE (s)
  0.0    ! L3: AVR lower limit
  6.0    ! L4: AVR upper limit
  1.0    ! SPEEDIN: use speed
  9.5    ! KPSS: PSS gain
  1.40   ! Tw: PSS washout (s)
  0.15   ! T1 (s)
  0.03   ! T2 (s)
  0.15   ! T3 (s)
  0.03   ! T4 (s)
...
<TabItem label="RAMSES Data File">
```
exc exc_generic2 GEN1
  0.0    ! Xc: line-drop compensation
  0.02   ! Tr: voltage filter (s)
  1.0    ! C: TGR gain
  0.10   ! Tc: TGR lead (s)
  1.00   ! Tb: TGR lag (s)
  200.0  ! Ka: AVR gain
  0.05   ! Ta: AVR time constant (s)
  5.0    ! Ki: integral gain
  1.0    ! Kp: proportional gain
  6.0    ! VrmaxD (pu)
  -6.0   ! VrminD (pu)
  1.0    ! G: exciter gain
  0.0    ! Ke
  0.50   ! Te: exciter lag (s)
  3.10   ! E1
  0.066  ! SeE1
  4.18   ! E2
  0.91   ! SeE2
