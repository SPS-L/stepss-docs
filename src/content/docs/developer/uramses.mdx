...
Apple Silicon only — the pre-compiled `modules_mac/` kit contains arm64 objects
and no Intel-mac kit is distributed. On an Intel Mac, build inside Docker instead.
