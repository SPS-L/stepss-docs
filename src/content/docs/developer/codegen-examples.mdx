...
For the block reference, see [CODEGEN Blocks](/developer/codegen-blocks/). For the model framework (states, equations, initialization), see [User-Defined Models](/developer/user-models/).
