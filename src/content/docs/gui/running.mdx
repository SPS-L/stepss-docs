...
Episode 5 of the [video series](/resources/videos/), *Observables, Trajectories and Plotting*, covers this page.
...
The five inspection buttons beside **Run power flow** become available now:
**Bus overview**, **Branch flows**, **Generators & SVCs**, **Adjustable
transformers** and **Global power balance**, each of which writes its table
into the same pane. [The Interface](/gui/interface/#power-flow-simulation)
...
If you set the runtime observables in step 2, a **Run-time curves** window drew
them as the run advanced and is still up when it finishes; see
[Real-time plotting](/gui/first-run/#real-time-plotting).
...
The oscillation **decays**, and after about ten seconds both machines settle a few
