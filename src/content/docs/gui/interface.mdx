...
**Tools** holds **Select external simulator** and **Close all curve windows**;
and, below a separator, the **Dark theme** toggle and **Check for updates at
startup**. The last two are ticks rather than
actions, and both are remembered between sessions.

<img src="/images/screenshots/gui-tools-menu-light.png"
     alt="The Tools menu open, holding Select external simulator with Ctrl+R and Close all curve windows with Ctrl+G, then below a separator the Dark theme and Check for updates at startup ticks, both unticked."
     class="dark:sl-hidden" />
<img src="/images/screenshots/gui-tools-menu-dark.png"
     alt="The Tools menu open, holding Select external simulator with Ctrl+R and Close all curve windows with Ctrl+G, then below a separator the Dark theme tick, which is ticked, and Check for updates at startup."
     class="light:sl-hidden" />
