...
<img src="/images/screenshots/gui-analysis-light.png"
     alt="The Analysis tab with a completed run available. A Time-domain analysis row offers Extract curves, Save current trajectory and Load trajectory, with Close all curve windows at the right. Below it a Small-signal stability analysis section offers Select results directory beside an empty field, a basename of ssa, an analysis time of 0.001 seconds, a real part limit of -1.0 and a participation-factor threshold of 0.05, with buttons to run the analysis and to save or load the dynamic Jacobian."
     class="dark:sl-hidden" />
