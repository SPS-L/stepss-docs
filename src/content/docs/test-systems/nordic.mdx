...
| `doc/` | IEEE PES-TR19 report, detailed system report (V6), and operating-point variants description |
| `scripts/` | PyRAMSES, Python, and MATLAB/Simulink example scripts |
...
The [stepss-IEEE-Nordic-Test-system](https://github.com/SPS-L/stepss-IEEE-Nordic-Test-system) repository is licensed under the [Apache License 2.0](https://github.com/SPS-L/stepss-IEEE-Nordic-Test-system/blob/main/LICENSE). The IEEE PES-TR19 report redistributed in its `doc/` folder remains © IEEE.
