...
<LinkCard
  ...
  href="https://github.com/SPS-L/IEEE-Nordic-Test-system"
/>
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/SPS-L/IEEE-Nordic-Test-system.git
...
The [IEEE-Nordic-Test-system](https://github.com/SPS-L/IEEE-Nordic-Test-system) repository is licensed under the [Apache License 2.0](https://github.com/SPS-L/IEEE-Nordic-Test-system/blob/main/LICENSE). The IEEE PES-TR19 report redistributed in its `doc/` folder remains © IEEE.
