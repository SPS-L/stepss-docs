...
Episode 10 of the [video series](/resources/videos/), *Capstone: Voltage Collapse on the Nordic System*, covers this page.
...
- Python 3 with [stepss](/python/installation/) installed
- JupyterLab (recommended) or any Python environment

Install stepss following the [installation guide](/python/installation/).
...
- [Python API Examples](/python/examples/#nordic-test-system-generator-trip), Complete Python simulation workflow with this test system
- [Python API Reference](/python/api-reference/), Full API documentation for scripting simulations
